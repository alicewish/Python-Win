...
for file_name in file_list:
    ...
    extension_list = [".gsheet"]
    if not is_dir and extension in extension_list and ".csv" in file_name or ".CSV" in file_name:
        new_file_name = file_name.replace(".csv", "").replace(".CSV", "")
